...
async function searchCongregationMembers(congregation: string, searchTerm: string): Promise<{ success: boolean, error?: any, data?: any }> {
...
export default searchCongregationMembers;