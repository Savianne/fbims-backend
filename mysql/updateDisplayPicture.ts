...
async function updateDisplayPicture(memberUID: string, updateData: IDisplayPictureUpdate): Promise<{ querySuccess: boolean }> {
    ...
    return new Promise<IQueryPromise>((resolve, reject) => {
        ...
        .then(connection => {
            ...
            .then(async () => {
                ...
                SELECT avatar FROM members WHERE member_uid = ?
                ...
                updateData.query == "remove" && await (async () => {
                    ...
                    await connection.query("UPDATE members SET avatar = NULL WHERE member_uid = ?", [memberUID]); 
                ...
                updateData.query == "update" && await (async () => {
                    ...
                    newFkey && await connection.query(`UPDATE members SET avatar = ? WHERE member_uid = ?`, [newFkey, memberUID]);
