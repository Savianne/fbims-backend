...
const sendOTPReqHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = {
    ...
    const otp = otp_generator_1.default.generate(5, { upperCaseAlphabets: false, lowerCaseAlphabets: false, specialChars: false, digits: true });
    const config = {
        service: 'gmail',
        auth: {
    ...
    const message = {
        ...
        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
        <tr>
        <td align="center" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;color:#333333;font-size:16px">One Time Pin ( OTP )</p></td>
        </tr>
        </table></td>
        </tr>
        </table></td>
        ...
        <tr>
        <td align="center" class="h-auto" height="60" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:35px;color:#333333;font-size:35px"><strong id="otp">${otp}</strong></p></td>
        </tr>
        </table></td>
        </tr>
        </table></td>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
        <tr>
        <td align="center" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:20px;color:#333333;font-size:13px"><em>Expires after : ${expirationDate}</em></p></td>
        </tr>
        </table></td>
        </tr>
        </table></td>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
        <tr>
        <td align="center" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px"><strong>Query:</strong> Forgot Password</p></td>
        </tr>
        <tr>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
        <tr>
        <td align="center" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Click the button to Invalidate Request</p></td>
        </tr>
        </table></td>
        </tr>
        </table></td>
    ...
    transport.sendMail(message).then(response => {
        ...
        const pendingOTPCookie = jsonwebtoken_1.default.sign(OTP, access_token_secret, { expiresIn });
        res.cookie('pendingOTP', pendingOTPCookie, { httpOnly: true });
        return res.json({ otpSendSuccess: true, otpExpiration: expirationDate });
    });
});
exports.default = sendOTPReqHandler;
