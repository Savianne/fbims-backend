...
const verifyForgotPassOTP = (req, res) => {
    ...
    if (!pendingOTPCookie)
        return res.status(401).send("NO Pending OTP");
    jsonwebtoken_1.default.verify(pendingOTPCookie, access_token_secret, (error, decoded) => __awaiter(void 0, void 0, void 0, function* () {
        if (error) {
        ...
        if (decoded) {
            ...
            if (otp.trim() == otpInput.trim()) {
                ...
                const fpToken = jsonwebtoken_1.default.sign({ user, expDate: expirationDate }, access_token_secret, { expiresIn });
...
exports.default = verifyForgotPassOTP;
