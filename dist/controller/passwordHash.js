...
exports.decryptPassword = exports.incryptPassword = void 0;
...
function decryptPassword(password, toCompare) {
    return __awaiter(this, void 0, void 0, function* () {
        const decrypted = yield bcrypt_1.default.compare(password, toCompare);
        return decrypted;
    });
}
