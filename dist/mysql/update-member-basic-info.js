...
function updateMemberBasicInfo(memberUID, updateData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            promisePool.getConnection()
                ...
                FROM members AS m 
                    JOIN members_personal_info AS mpi ON m.personal_info 
                WHERE m.member_uid = ?
                `, [memberUID]))[0])[0].full_name;
                    //Update full Name
                    yield connection.query(`
                UPDATE full_name SET first_name = ?, middle_name = ?, surname = ?, ext_name = ?
                WHERE id = ?
                `, [updateData.first_name, updateData.middle_name, updateData.surname, updateData.first_name, getFKey.full_name]);
                    yield connection.query(`
