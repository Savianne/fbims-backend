...
function getCongregationAttendanceCategories(congregation) {
        ...
        return new Promise((resolve, reject) => {
            promisePool.getConnection()
                ...
                connection.beginTransaction()
                    ...
                    const categories = ((yield connection.query(`
                ...
                `, [congregation]))[0]);
                    ...
                    connection.commit();
                    connection.release();
                    resolve({ querySuccess: true, data: categories });
                }))
...
exports.default = getCongregationAttendanceCategories;
