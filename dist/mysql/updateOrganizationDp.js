...
function updateOrganizationDisplayPicture(orgUID, updateData) {
            ...
            promisePool.getConnection()
                ...
                `, [orgUID]))[0])[0];
                    updateData.query == "remove" && (yield (() => __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield connection.query("UPDATE organizations SET avatar = NULL WHERE organization_uid = ?", [orgUID]);
                    ...
                    updateData.query == "update" && (yield (() => __awaiter(this, void 0, void 0, function* () {
                        ...
                        newFkey && (yield connection.query(`UPDATE organizations SET avatar = ? WHERE organization_uid = ?`, [newFkey, orgUID]));
                    }))());
                    //Commit 
                    connection.commit();
                    connection.release();
...
exports.default = updateOrganizationDisplayPicture;
