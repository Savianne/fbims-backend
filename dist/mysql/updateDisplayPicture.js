...
function updateDisplayPicture(memberUID, updateData) {
            ...
            promisePool.getConnection()
                ...
                `, [memberUID]))[0])[0];
                    updateData.query == "remove" && (yield (() => __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield connection.query("UPDATE members SET avatar = NULL WHERE member_uid = ?", [memberUID]);
                    ...
                    updateData.query == "update" && (yield (() => __awaiter(this, void 0, void 0, function* () {
                        ...
                        newFkey && (yield connection.query(`UPDATE members SET avatar = ? WHERE member_uid = ?`, [newFkey, memberUID]));
                    }))());
                    //Commit 
                    connection.commit();
                    connection.release();
...
exports.default = updateDisplayPicture;
